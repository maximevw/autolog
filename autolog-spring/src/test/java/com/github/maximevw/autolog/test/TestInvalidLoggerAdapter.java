...
/**
 * This class is an invalid implementation of {@link LoggerInterface} used in unit tests of Autolog Spring
 * auto-configuration.
 */
public class TestInvalidLoggerAdapter implements LoggerInterface {
	@Override
