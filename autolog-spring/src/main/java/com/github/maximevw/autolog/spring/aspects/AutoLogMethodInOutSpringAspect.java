...
import com.github.maximevw.autolog.aspectj.aspects.AutoLogMethodInOutAspect;
...
@Component
public class AutoLogMethodInOutSpringAspect extends AutoLogMethodInOutAspect {
	 ...
	 */
	@Autowired
	public AutoLogMethodInOutSpringAspect(final LoggerManager loggerManager) {
		super(loggerManager);
	}
